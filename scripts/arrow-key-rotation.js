AFRAME.registerComponent('arrow-key-rotation', {
    ...
    onKeyDown: function (evt) {
      switch (evt.keyCode) {
        case 37: this.directionX = this.directionX++; break;
        case 38: this.directionY = this.directionY++; break;
        case 39: this.directionX = this.directionX--; break;
        case 40: this.directionY = this.directionY--; break;
      }
    },
